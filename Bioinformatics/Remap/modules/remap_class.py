...
from utilities.utilities_general import plot_dotplot, read_paf_coordinates
...
class Mapping_Manager(Tandem_Remap):
    ...
    def clean_mapping_files(self):
        for instance in self.mapped_instances:
            instance.reference.cleanup_files()
            if instance.assembly:
                if instance.assembly.number_of_contigs_mapped > 0:
                    instance.assembly.cleanup_files()
